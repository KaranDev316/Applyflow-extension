...
function ApplicationItem({ application, onDelete }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "group flex min-w-0 items-start gap-2 overflow-hidden rounded-md border border-slate-200 bg-white px-3 py-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-w-0 flex-1 basis-0", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-1 flex min-w-0 max-w-full flex-wrap items-center gap-2 overflow-hidden", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "shrink-0 text-xs text-slate-400", children: formatDate(application.appliedAt) }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
            className: `shrink-0 whitespace-nowrap rounded-full px-2 py-0.5 text-[10px] font-semibold ${application.status === "applied" ? "bg-emerald-100 text-emerald-700" : "bg-amber-100 text-amber-700"}`,
...
function ApplicationList({ applications, error, isLoading, onDelete, statusFilter = "all" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid min-w-0 gap-2.5 overflow-hidden", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrackerMetrics, { applications: normalizedApplications }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-w-0 space-y-4 overflow-hidden", children: [
      filteredDraftApplications.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "min-w-0 overflow-hidden", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid min-w-0 gap-1.5 overflow-hidden", children: filteredDraftApplications.map((app) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplicationItem, { application: app, onDelete }, app.id)) })
      ] }),
      filteredAppliedApplications.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "min-w-0 overflow-hidden", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid min-w-0 gap-1.5 overflow-hidden", children: filteredAppliedApplications.map((app) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplicationItem, { application: app, onDelete }, app.id)) })
      ] })
    ] })
  ] });
}
