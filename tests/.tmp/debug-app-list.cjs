...
function TrackerMetrics({ applications }) {
  ...
  const drafts = unique.filter((app) => getStatus(app) === "draft");
...
function ApplicationList({ applications, error, isLoading, onDelete }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid gap-2.5", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-4", children: [
      draftApplications.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid gap-1.5", children: draftApplications.map((app) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplicationItem, { application: app, onDelete }, app.id)) })
      ] }),
      appliedApplications.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid gap-1.5", children: appliedApplications.map((app) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplicationItem, { application: app, onDelete }, app.id)) })
      ] })
    ] })
  ] });
}
